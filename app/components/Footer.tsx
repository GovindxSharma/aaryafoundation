  ...
  return (
    <footer className="bg-green-900 text-white">
      <div className="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-gray-300">
            Dedicated to the protection and welfare of cows, promoting natural
            living, and spreading compassion through Gauseva.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-300 mb-4">
            Every donation helps us provide food, shelter and medical care to
            cows.
          </p>
      ...
      <div className="border-t border-green-800 text-center py-4 text-gray-300">
        © {new Date().getFullYear()} Aarya Foundation – Gauseva Initiative. All
        Rights Reserved.
      </div>
    </footer>
  );
